<?php
/**
 * This file is used to markup the article-slider-5.
 *
 * @since      1.0.1
...
foreach ($items as $key => $item)
{
  ?><div class="mslider-item
		<?php echo ($page_number > 1) ? 'mslider-item-hidden' : ''; ?>
 		...
 		<div class="mslider-item-outer-cont <?php echo $flipBase; ?> <?php echo $flipClass; ?>"
 			style="
